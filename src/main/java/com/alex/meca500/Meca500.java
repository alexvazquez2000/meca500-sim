...
public class Meca500 {
    ...
    public Meca500(RobotPart[] parts) {
        ...
        configureJoint(parts[2], Rotate.X_AXIS, 0, -49.14f,   0);      // J2 shoulder
        ...
        configureJoint(parts[5], Rotate.X_AXIS,     0,  -222.0f,  119.0f);   // J5 wrist pitch
        configureJoint(parts[6], Rotate.Z_AXIS,  15.54f, -222.0f,    184.6f);   // J6 flange spin
